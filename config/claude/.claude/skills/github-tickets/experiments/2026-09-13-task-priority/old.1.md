...
Priority follows the Story's blocked-PR chain (feature/fork-detection is mid-review, so it and its Story get P1) while the remaining maintenance/cleanup tasks are unblocked-but-not-urgent P2.
